...
namespace aes583 {
    ...
    typedef struct aesCipher {
        // length of key nk E {4, 6, 8}
        size_t keylength;
    } cipher_t;

    typedef struct aesPlaintext {
        char* data;
    } plaintext_t;

    typedef struct aesCiphertext {
        char* data;
    } ciphertext_t;
...
/*
 * According to FIPS 197 (https://csrc.nist.gov/pubs/fips/197/final)
 * the AES s-box consists of 256 (16 x 16) 8-bit integers.
 */
