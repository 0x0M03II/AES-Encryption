...
class AES {
    ...
    public:
        ...
        // For read-only round printing
        //explicit AES(const char* plaintext) : plaintext(plaintext) {}

        uint32_t aesWord(uint8_t key0, uint8_t key1, uint8_t key2, uint8_t key3);
        void invCipher(uint8_t in[16], uint8_t out[16], uint32_t* w, int Nr);
...
const uint8_t MixColumsMatrics[4][4] = {
        {0x02, 0x03, 0x01, 0x01},
        {0x01, 0x02, 0x03, 0x01},
        {0x01, 0x01, 0x02, 0x03},
        {0x03, 0x01, 0x01, 0x02}
...
const uint8_t InvMixColumsMatrics[4][4] = {
        {0x0e, 0x0b, 0x0d, 0x09},
        {0x09, 0x0e, 0x0b, 0x0d},
        {0x0d, 0x09, 0x0e, 0x0b},
        {0x0b, 0x0d, 0x09, 0x0e}
